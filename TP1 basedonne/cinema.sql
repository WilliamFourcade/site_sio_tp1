...
--
-- Serveur: 127.0.0.1
-- Généré le : Ven 24 Novembre 2023 à 16:06
...
(1, 'SIO le film', 2023, 'Science fiction', 'Phillipe et ses aventures en SIO ', 1, 'FR');
...
('Illan@gmail.com', 'Titouni', 'Illan', 'Ile de france');
...
(1, 'Phillipe.kuang@gmail', 0, 20),
(2, 'Phillipe.kuang@gmail', 1, 20);
...
--
ALTER TABLE `film`
  ADD CONSTRAINT `film_ibfk_3` FOREIGN KEY (`idFilm`) REFERENCES `notation` (`idFilm`) ON DELETE CASCADE ON UPDATE CASCADE,
